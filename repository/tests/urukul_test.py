...
from artiq.coredevice.suservo import SUServo                                  #imports everything from the artiq experiment library
...
class Urukul_Programmable(EnvExperiment):
    ...
    def build(self): #This code runs on the host device
        ...
        check_array = [d for d in dev_db.keys() if re.match(r"suservo\d+_ch\d+", d)] # regex101.com
