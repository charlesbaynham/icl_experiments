...
class FluorescencePulseMOTBeamAndImagingWithShutter(_Stub):
    pass


class FluorescencePulseMOTBeamWithShutter(_Stub):
    pass


class FluorescencePulseMOTBeamWithoutShutter(_Stub):
    pass


class FluorescencePulseSwitchOnly(_Stub):
    pass
