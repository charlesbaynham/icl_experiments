...
ANDOR_DIPOLE_TRAP_FORWARD_X = 189
ANDOR_DIPOLE_TRAP_FORWARD_Y = 160

ANDOR_DIPOLE_TRAP_BACKWARD_X = 189
ANDOR_DIPOLE_TRAP_BACKWARD_Y = 214

ANDOR_ROI_DIPOLE_TRAP_FORWARD_X0 = (
    ANDOR_DIPOLE_TRAP_FORWARD_X - ANDOR_ROI_DIPOLE_WIDTH / 2
)
ANDOR_ROI_DIPOLE_TRAP_FORWARD_X1 = (
    ANDOR_DIPOLE_TRAP_FORWARD_X + ANDOR_ROI_DIPOLE_WIDTH / 2
)
ANDOR_ROI_DIPOLE_TRAP_FORWARD_Y0 = (
