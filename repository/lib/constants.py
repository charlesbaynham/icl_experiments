...
_ANDOR_ROI_DIPOLE_WIDTH_SINGLE_IMAGE = 70
_ANDOR_ROI_DIPOLE_X_SHIFT_SINGLE_IMAGE = (
    10  # shift in the horizontal direction to have the streak not in the BG image
)
_ANDOR_ROI_DIPOLE_HEIGHT_BELOW_SINGLE_IMAGE = 20
_ANDOR_ROI_DIPOLE_HEIGHT_ABOVE_SINGLE_IMAGE = 10
...
ANDOR_ROI_DIPOLE_TRAP_FORWARD_SINGLE_IMAGE_Y0 = round(
    _ANDOR_DIPOLE_TRAP_FORWARD_Y - _ANDOR_ROI_DIPOLE_HEIGHT_BELOW_SINGLE_IMAGE
)
ANDOR_ROI_DIPOLE_TRAP_FORWARD_SINGLE_IMAGE_Y1 = round(
    _ANDOR_DIPOLE_TRAP_FORWARD_Y + _ANDOR_ROI_DIPOLE_HEIGHT_ABOVE_SINGLE_IMAGE
)
ROI_SHIFT_EXCITED_STATE = 10
