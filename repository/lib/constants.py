...
# FIXME: ROIs only suitable for absorption imaging
_ANDOR_ROI_DIPOLE_HEIGHT_ABOVE = 10
_ANDOR_ROI_DIPOLE_HEIGHT_BELOW = 10
_ANDOR_ROI_DIPOLE_WIDTH = 20
...
XXODT_LOWER_LOADING_689_STIR_DETUNING = -15e3
...
INTERFEROMETRY_PHASE_NOISE_STD = 2.0
INTERFEROMETRY_PHASE_NOISE_MEAN_1 = 8.0
INTERFEROMETRY_PHASE_NOISE_MEAN_2 = 8.0
