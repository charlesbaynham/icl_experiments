...
class ClockGlitchFilter(GenericDriver):
    ...
    def __init__(self, *args, id, **kwargs):
        ...
        # self.relockers = []
        # for i in range(n_relockers):
        #     self.relockers.append(RelockerChannel(i, self.instr))
        self.instr: _RawSerialInstance  # FIXME This is strange but copied from IJD relocker driver
