    ...
    * `do_imaging_hook`
    ...
    def build_fragment(self):
        ...
        self.setattr_param(
            "stir_att_in_bb_mot",
            FloatParam,
            "Stir beam attenuation in the start of broadband MOT",
            default=30.0,
        )
        self.stir_att_in_bb_mot: FloatParamHandle
    ...
    def run_once(self):
        ...
        with parallel:
            ...
            with sequential:
                ...
                # Set the stir sidebands to higher power
                self.blue_3d_mot.mirny_eom_sidebands.set_689_stir_sideband_attenuation(
                    self.stir_att_in_bb_mot.get()
                )
                print("stir beam attenuation set to", self.stir_att_in_bb_mot.get())
            ...
            with sequential:
                ...
                print("attenuation back to", attenuation)
