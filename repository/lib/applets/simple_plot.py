...
class XYPlot(pyqtgraph.PlotWidget):
    def __init__(self, args, req):
        ...
        self.mismatch = {"X values": False, "Error bars": False, "Fit values": False}
...
def main():
    ...
    applet.add_dataset("points_x", "x values for extra points", required=False)
    applet.add_dataset("points_y", "y values for extra points", required=False)
    applet.run()
