...
class Urukul_Programmable(EnvExperiment):
    ...
    def run(self):  
        self.core.reset()                                      
        self.my_urukul.cpld.init()                            
        self.my_urukul.init()                                                                        
        
        
        self.my_urukul.set_att(self.atten)                    #writes attenuation to urukul channel
        self.my_urukul.sw.on()                                #switches urukul channel on
           
            
        self.my_urukul.set(self.freq, amplitude = self.amp)   #writes frequency and amplitude attributes to urukul channel thus outputting function                             #delay determined by user input
        self.my_urukul.sw.off()                               #switches urukul channel off