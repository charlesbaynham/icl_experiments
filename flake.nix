      ...
      apps =
        ...
        // {
          ...
          full_stack = let
            ...
            monitor_launcher = "sleep 60 && artiq_client -s ${bind_settings.connection_ip} submit -p monitors -P -10 -R -r master --flush -c MonitorMaster repository/monitors/monitor_master.py && sleep infinity";
            ...
            wand_setpoints_launcher = "sleep 60 && artiq_client -s ${bind_settings.connection_ip} submit -p startup -P -5 -r master -c SetWandSetpoints repository/utilities/set_wand_setpoints.py && sleep infinity";
