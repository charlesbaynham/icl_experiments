## device_db.py
# This is the raw, generated device_db for your system, pasted from the Gitlab
# pipeline's output at
# https://gitlab.com/aion-physics/code/artiq/bitstreams/aion_gateware
# This is the ICL variant, but replace with your own
